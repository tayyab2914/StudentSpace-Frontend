...
export const LANDING_IMAGE_COMPONENT = ({ navigate }: { navigate: NavigateFunction }) => {
...
// IMAGE_COMPONENT_2
export const IMAGE_COMPONENT_2 = ({ navigate }: { navigate: NavigateFunction }) => {
  const [isImageLoaded, setIsImageLoaded] = useState(false);
...
export const FACULTY_CARDS = ({ navigate }: { navigate: NavigateFunction }) => (
  <>
      ...
      <div className="row m-0 px-2">
        ...
        >
          <Card
            ...
            cover={
              <Image
                src="https://res.cloudinary.com/dmlxb4ea9/image/upload/v1726685552/tech_company-amico_kq2tjk.svg"
                alt="Faculty of Information and Technology"
                width={300}
                height={200}
          ...
          >
            <div className="row m-0">
              ...
              >
                ...
                <button className="button text-center mt-auto w-100">
                  <p className="text m-0">View Faculty</p>
                </button>
              </div>
            </div>
          </Card>
        ...
        >
          <Card
            ...
            cover={
              <Image
                src="https://res.cloudinary.com/dmlxb4ea9/image/upload/v1726685552/Printed_circuit_board-amico_tkssap.svg"
        ...
        >
          <Card
            ...
            cover={
              <Image
                src="https://res.cloudinary.com/dmlxb4ea9/image/upload/v1726685551/Halloween_Instagram_feed-amico_jgomby.svg"
        ...
        >
          <Card
            ...
            cover={
              <Image
                src="https://res.cloudinary.com/dmlxb4ea9/image/upload/v1726685558/Translator-amico_qgfwz8.svg"
                alt="Faculty of Languages and Literature"
                width={300}
                height={200}
                className="faculty-image"
                style={{ objectFit: 'cover' }}
        ...
        >
          <Card
            ...
            cover={
              <Image
                src="https://res.cloudinary.com/dmlxb4ea9/image/upload/v1726685560/Universal_declaration_of_human_rights-amico_mhrvdo.svg"
                alt="Faculty of Law"
                width={300}
                height={200}
                className="faculty-image"
        ...
        >
          <Card
            ...
            cover={
              <Image
                src="https://res.cloudinary.com/dmlxb4ea9/image/upload/v1726685551/Journalist-amico_aay5fw.svg"
                alt="Faculty of Media and Mass Communication"
                width={300}
                height={200}
                className="faculty-image"
                style={{ objectFit: 'cover' }}
        ...
        >
          <Card
            ...
            cover={
              <Image
                src="https://res.cloudinary.com/dmlxb4ea9/image/upload/v1726685552/Manage_money-amico_c7sa2a.svg"
        ...
        >
          <Card
            ...
            cover={
              <Image
                src="https://res.cloudinary.com/dmlxb4ea9/image/upload/v1726685548/chemistry_lab-rafiki_g1vdme.svg"
        ...
        >
          <Card
            ...
            cover={
              <Image
                src="https://res.cloudinary.com/dmlxb4ea9/image/upload/v1726685551/Science-amico_cjucsg.svg"
                alt="Faculty of Science and Technology"
                width={300}
                height={200}
                className="faculty-image"
                style={{ objectFit: 'cover' }}
